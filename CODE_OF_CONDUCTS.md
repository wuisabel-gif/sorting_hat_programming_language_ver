...
We as members, contributors, and maintainers pledge to make participation in The Hat of Many Languages a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, religion, or sexual identity and orientation.

We pledge to act and interact in ways that contribute to an open, welcoming, diverse, inclusive, and healthy community. The spirit of this project is that *every* programming language is a good first choice and *every* beginner is welcome — we hold ourselves to the same standard with each other.
...
- Welcoming newcomers and beginners with patience — language wars and gatekeeping have no place here.
...
- Demeaning someone's choice of programming language, skill level, or background.
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the project maintainers responsible for enforcement at **[INSERT CONTACT METHOD — e.g. an email address or a private contact form]**.
...
> **Maintainer note:** replace the contact placeholder above before publishing. A code of conduct with no working way to report a problem can't actually protect anyone.
...
### 4. Permanent ban
**Community impact:** Demonstrating a pattern of violation of community standards, harassment of an individual, or aggression toward or disparagement of groups of individuals.
